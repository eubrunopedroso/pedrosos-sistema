# [Nome da Agência] — regras do negócio
...
**Estrutura de pastas:**
- `obsidian-vault/` — quem é a agência, como falamos, foco atual
  (índice em `00 - Visão Geral.md`, uma nota por assunto)
...
- Se o projeto envolver site: registrar aqui suas próprias regras
  técnicas à medida que forem surgindo (mobile-first, proteção de
  conteúdo, dado pessoal/LGPD, deploy, segurança) — não existe padrão
  fixo importado, cada regra nasce de uma decisão sua
