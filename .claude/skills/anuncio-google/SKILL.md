...
description: >
  ...
  negativas. Lê o briefing perguntado direto ao usuário (produto/serviço,
  público, região, diferenciais) e da pesquisa SEO se existir.
...
- **Contexto do negócio:** perguntar ao usuário (produto/serviço, público, região, diferenciais) — não vive mais em nota fixa do vault
...
Seguir o tom que o usuário passar (perguntar se não tiver ficado claro).
...
- **Chamadas** (telefone): perguntar ao usuário
...
- Copies seguem o tom que o usuário passar, estritamente. Sem jargão de marketing se o público não usa.
