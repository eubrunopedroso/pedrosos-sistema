...
- **Contexto:** perguntar ao usuário — identidade visual não tem guia fixo desde 23/08/2026, quem resolve isso é a própria `/carrossel` no Passo 3
...
author: "<nome do usuário ou da empresa — perguntar se não tiver ficado claro>"
keywords:
  - keyword principal
  - variação 1
  - variação 2
...
**Regras de escrita** (seguir o tom que o usuário passar, estritamente):
