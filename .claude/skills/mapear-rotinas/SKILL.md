...
Ler `templates/skills/catalogo.md` pra ver se alguma das tarefas mencionadas já é coberta por uma skill nativa do Claude Code ou validada pelo PedrosOS. Se sim, sugerir a skill existente em vez de criar uma nova:
...
**Dependências:** [notes do obsidian-vault/, identidade/, ou ferramentas externas]
```
...
4. Calibrar o tom e regras perguntando ao usuário — não vivem mais em nota fixa do vault
