...
Conferir o nome da pasta atual (`basename "$(pwd)"`). Se for `mazyos`, `MazyOS`, `MazyOS-main`, `mazyos-main`, `pedrosos`, `PedrosOS`, `PedrosOS-main`, `pedrosos-main` ou variação genérica:
