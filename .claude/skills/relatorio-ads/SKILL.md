...
- **Contexto:** perguntar ao usuário — não vive mais em nota fixa do vault
...
- **Linguagem do dono.** Seguir o tom que o usuário passar. CPM, CTR, CPA são OK se o dono já entende; se não, traduzir ("custo por mil pessoas que viram", "% de quem clicou", "quanto custou cada cliente").
