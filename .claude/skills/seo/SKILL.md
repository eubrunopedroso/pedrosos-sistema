...
description: >
  ...
  "pesquisa de nicho". Pra "google trends"/"trending now"/"em alta" sozinho
  (sem contexto de SEO/nicho), quem roda é a skill `/trends`, não esta.
---
...
- **Contexto do negócio:** perguntar ao usuário (produto/serviço, região, público, diferenciais) — não vive mais em nota fixa do vault
- **Tom de voz:** perguntar ao usuário, ou seguir o que ele já escreveu na conversa
- **Estratégia atual:** perguntar ao usuário
...
1. Perguntar ao usuário pra extrair: produtos/serviços, região, público-alvo, diferenciais
...
2. Criar documento com **tudo que precisa ser preenchido/otimizado:**
   ...
   **Descrição do negócio:**
   ...
   - Tom: conforme o que o usuário passar
...
3. **Copies dos anúncios:**
   - Seguir o tom que o usuário passar
...
- Copies e textos seguem o tom que o usuário passar, estritamente
