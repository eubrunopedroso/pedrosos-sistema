...
- **Contexto do negócio:** perguntar ao usuário — não vive mais em nota fixa do vault
...
5. **Tom:** seguir o que o usuário passar. Sem jargão de marketing. Sem "premium", "qualidade ímpar", "experiência diferenciada".
...
- **Evitar (tom de marketing genérico):** ✨ 🎉 💯 🚀 (a menos que combine com o tom que o usuário passar)
